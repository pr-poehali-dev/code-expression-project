...
PROJECT_KNOWLEDGE = """ПРОЕКТ «ПРО ДИАЛОГ» (promtdialog.ru)
...
ИИ-диагностика клиента, анализ мышления специалиста, анализ барьеров, финансовый профиль PRO, диагностика роста салона PRO, генератор постов, сценарии Reels, скрипты продаж, ответы на отзывы.
...
ТАРИФЫ САЛОНЫ: Стандарт (190 000₽/6мес/5 чел.), Премиум (490 000₽/год/15 чел.+встречи), PRO Business (от 1 200 000₽).
Энергия — внутренняя валюта. 100 энергий при регистрации. Баланс общий на салон, лимиты по сотрудникам."""
