...
ОБЯЗАТЕЛЬНАЯ СТРУКТУРА (5 блоков):
1. <header> — логотип/название + пункты навигации + кнопка CTA (фиксированный, белый фон, тонкая тень)
...
- Desktop (768px+): горизонтальное меню в header — ссылки на якоря (#services, #advantages, #contact) + кнопка CTA справа
- Mobile (до 768px): навигационные ссылки скрыты, вместо них — кнопка-гамбургер (три полоски ☰)
- При клике на гамбургер — меню раскрывается вертикально под хедером (аккордеон): ссылки в столбик, плавная анимация max-height
- При клике на ссылку в мобильном меню — меню закрывается
- JS для гамбургера: простой toggle класса .open на nav, transition на max-height (0 → 300px)
