...
Вызывается при реальных пополнениях баланса салона.
Начисляет 10% только с платных транзакций (НЕ бонусных).
POST / — внутренний вызов при пополнении баланса салона.
...
# Только эти типы пополнений дают партнёрское вознаграждение
PAID_ACTIONS = {"Покупка пакета энергии", "Пополнение баланса"}
