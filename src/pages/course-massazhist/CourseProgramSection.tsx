...
import { ACCENT, MODULES, REVIEWS, AccordionItem, h2style } from "./CourseShared";
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
          <div style={{
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }} className="course-2col">
              {[
                "Знаете анатомию, физиологию и биомеханику тела",
                "Умеете работать с позвоночником, фасциями и мышцами",
                "Делаете диагностику и корректируете дисфункции",
                "Владеете техниками медицинского массажа",
                "Понимаете психосоматику и работаете с эмоциональными блоками",
                "Можете принимать клиентов и уверенно зарабатывать",
              ].map((item) => (
