...
const AUDIT_BENEFITS = [
  ...
  { icon: "Bot", text: "Интеграция ИИ-инструментов «Промт Диалог» в работу салона" },
];
...
const AUDIT_STEPS = [
  ...
  { n: "04", text: "Помогаем внедрить изменения с поддержкой платформы «Промт Диалог»" },
];
...
export default function DlyaSalonov() {
  useEffect(() => {
    document.title = "Аудит салона красоты под премиум-клиентов — Промт Диалог";
    const desc = document.querySelector("meta[name='description']");
    if (desc) desc.setAttribute("content", "Аудит салона красоты для привлечения премиальных клиентов. Анализ бизнес-процессов, увеличение среднего чека, оптимизация работы команды. Платформа «Промт Диалог».");
  }, []);
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          ...
          <div style={{ maxWidth: 760, marginBottom: 64 }}>
            ...
            <p style={{ fontSize: 17, color: GRAY, lineHeight: 1.75, margin: 0 }}>
              Сегодняшний премиальный клиент — это человек с высокими запросами к качеству, атмосфере и сервису. «Промт Диалог» проводит глубокий аудит вашего салона с акцентом на привлечение и удержание этой аудитории. Обнаружим скрытые точки роста и покажем, как увеличить доход без дополнительной рекламы.
            </p>
          </div>
