...
export default function Masters() {
  const steps = [
    ...
    { num: "03", icon: "Send", title: "Пригласите руководство", desc: "Поделитесь ссылкой с владельцем или управляющим вашего или любого другого салона. Они зарегистрируются — вы привязаны автоматически." },
  ...
  const faq = [
    { q: "Кто может участвовать?", a: "Администраторы, мастера, управляющие и любые специалисты индустрии красоты. Для вывода денег потребуется статус самозанятого или ИП и ИНН." },
    ...
    { q: "Что если я уволюсь из салона?", a: "Ничего не изменится. Реферальная связь не зависит от места работы. Пока салон тратит деньги на платформе — вы получаете 10%." },
        ...
        <div className="m-hero-inner" style={{ maxWidth: 1200, margin: "0 auto", padding: "60px 20px 80px", width: "100%" }}>
          ...
          <div className="m-hero-content">
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, border: `1px solid rgba(201,169,110,0.4)`, borderRadius: 100, padding: "6px 14px", marginBottom: 28 }}>
              ...
              <span style={{ fontSize: 11, color: GOLD, fontWeight: 600, letterSpacing: 1.5, textTransform: "uppercase" }}>Партнёрская программа для администраторов и мастеров</span>
            </div>
          ...
          <div className="m-hero-photo">
            ...
            <div style={{ width: "100%", aspectRatio: "7/8", borderRadius: 24, overflow: "hidden" }}>
              <img src="https://cdn.poehali.dev/projects/10f61e56-9821-40f3-b705-3590ddaffd08/bucket/62e0ee86-64f1-4db9-aad5-11162cb25d83.png" alt="Мастера" loading="lazy" decoding="async" style={{ width: "100%", height: "100%", objectFit: "cover", objectPosition: "center top" }} />
            </div>
