...
const SECTIONS = [
  {
    ...
    tools: [
      ...
      { icon: "Image", name: "Концепции изображений", desc: "Структурированный бриф для дизайнера или нейросети." },
      { icon: "Star", name: "Ответы на отзывы", desc: "Выверенные ответы на отзывы любой тональности." },
    ],
  },
  {
    tag: "Управление",
