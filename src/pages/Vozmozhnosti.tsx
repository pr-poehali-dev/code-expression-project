...
const SECTIONS = [
  {
    ...
    tools: [
      ...
      { icon: "Video",         name: "Сценарии и видео для Reels",   desc: "Готовый сценарий для съёмки — или сразу видеоролик, сгенерированный ИИ, для привлечения новых клиентов." },
      { icon: "Image",         name: "Генерация изображений",        desc: "Создаёт уникальные визуалы для постов, баннеров и рекламных материалов." },
      { icon: "Wand2",         name: "Примерочная",                  desc: "Мастер загружает фото клиента и по его пожеланиям показывает новый образ ещё на консультации: стрижку, макияж, маникюр или смену стиля. Клиент принимает решение о записи сразу, глядя на результат, а не на обещания." },
