...
const SECTIONS = [
  {
    ...
    tools: [
      ...
      { icon: "Wand2",         name: "Примерочная",                  desc: "Клиент загружает фото — и ещё до визита видит свой новый образ: стрижку, макияж, маникюр или смену стиля. Решение о записи принимается сразу, глядя на результат, а не на обещания." },
