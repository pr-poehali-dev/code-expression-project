...
const SECTIONS = [
  {
    ...
    subdesc: "Инструменты помогают регулярно публиковать качественный контент, поддерживать активность в социальных сетях и создавать собственный сайт или лендинг без привлечения специалистов.",
    tools: [
      { icon: "PenLine",        slug: "post-generator",    name: "Генератор постов",            desc: "Создаёт готовые публикации для соцсетей с учётом тематики и вашего стиля за пару минут." },
      ...
      { icon: "MousePointer",   slug: "ad-campaigns",       name: "Создание рекламных кампаний", desc: "Готовит объявления для Яндекс.Директ: заголовки и тексты на основе ваших услуг и аудитории." },
      { icon: "LayoutTemplate", slug: "landing-builder",    name: "Конструктор лендингов и сайта", desc: "Собирает продающую страницу или сайт под вашу услугу за несколько минут — без программирования и участия веб-дизайнера." },
      { icon: "Globe",          slug: "seo-optimization",   name: "SEO-оптимизация сайта",       desc: "Анализирует ваш сайт: мета-теги, заголовки, тексты — и выдаёт готовые варианты правок." },
  ...
  },
  {
    ...
    subdesc: "Инструменты помогают владельцу и специалисту частной практики видеть картину целиком и принимать решения на основе данных.",
    tools: [
      { icon: "UserSearch",    slug: "staff-analysis",      name: "Анализ персонала",         desc: "Показывает вклад каждого сотрудника в прибыль компании и помогает находить скрытые потери." },
      { icon: "ClipboardList", slug: "business-audit",      name: "Цифровой бизнес-разбор",   desc: "Даёт комплексный анализ текущего состояния бизнеса с персональными рекомендациями по росту." },
      { icon: "Stethoscope",   slug: "growth-diagnostics",  name: "Диагностика роста дохода", desc: "Помогает оценить маркетинг, сервис, продажи и загрузку, чтобы найти точки роста." },
    ],
  },
  {
    tag: "Продажи",
    ...
    subdesc: "",
    tools: [
      { icon: "MessagesSquare", slug: "scripts",             name: "Скрипты общения",       desc: "Готовые сценарии для записи, консультации и решения сложных ситуаций с клиентом." },
      { icon: "ShieldCheck",    slug: "objection-handling",  name: "Работа с возражениями", desc: "Даёт практические модели ответов на типовые сомнения и возражения клиентов." },
      { icon: "RotateCcw",      slug: "repeat-booking",      name: "Повторная запись",       desc: "Помогает увеличивать возврат клиентов и загрузку расписания специалистов." },
    ],
  },
  {
    tag: "Специалисты",
...
const WHY_ITEMS = [
  ...
  "Инструменты, которые помогают бизнесу и частной практике расти каждый день.",
  "Экономия на найме маркетолога, веб-дизайнера и консультантов.",
];

const FLOW_STEPS = [
  { icon: "Database",   label: "Ваши данные" },
...
const HOW_STEPS = [
  { num: "1", title: "Анализ данных",              desc: "Алгоритмы обрабатывают показатели бизнеса, сотрудников или задачи пользователя." },
...
export default function Vozmozhnosti() {
  return (
    <div style={{ fontFamily: "Inter, sans-serif", background: "#fff" }}>
      <Helmet>
        <title>Возможности платформы — маркетинг, обучение и ИИ для бизнеса | Промт Диалог</title>
        <meta name="description" content="Более 20 инструментов для роста дохода: генератор постов, конструктор лендингов, сценарии Reels, SEO-оптимизация, анализ персонала, скрипты продаж, обучение команды. Для салонов красоты, психологов и частной практики. Попробуйте бесплатно." />
        <meta name="keywords" content="инструменты для салона красоты, конструктор лендингов, маркетинг для бизнеса, обучение персонала, ИИ для салона, ИИ для психолога, платформа управления бизнесом" />
        <link rel="canonical" href="https://promtdialog.ru/vozmozhnosti" />
        <meta property="og:title" content="Возможности платформы Промт Диалог — всё для роста дохода" />
        ...
        <meta name="twitter:description" content="Более 20 инструментов для роста дохода: маркетинг, ИИ, конструктор лендингов, обучение команды." />
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "Платформа роста дохода для салонов красоты, психологов и частной практики: маркетинг, управление, обучение персонала и ИИ-инструменты в одном кабинете.",
          "offers": { "@type": "Offer", "price": "0", "priceCurrency": "RUB", "description": "Получить план роста дохода — бесплатно" },
          "featureList": ["Генератор постов", "Конструктор лендингов", "Сценарии и видео для Reels", "SEO-оптимизация", "Анализ персонала", "Скрипты продаж", "Обучение команды"],
          "operatingSystem": "Web"
        })}</script>
      </Helmet>
      <BizNavbar />
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "100px 32px", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center", position: "relative" }} className="voz-hero-grid">
          <div>
            ...
            <h1 style={{ fontFamily: SERIF, fontSize: "clamp(40px,5.5vw,70px)", fontWeight: 500, color: "#fff", lineHeight: 1.05, margin: "0 0 28px", letterSpacing: "-0.5px" }}>
              Больше клиентов, выше доход, сильнее команда
            </h1>
            <p style={{ fontSize: "clamp(15px,1.6vw,18px)", color: "rgba(255,255,255,0.62)", lineHeight: 1.7, margin: "0 0 16px", fontWeight: 300, maxWidth: 520 }}>
              20+ ИИ-инструментов, которые каждый день работают на рост вашего дохода — без найма консультантов, дизайнеров и лишних сервисов.
            </p>
          ...
          <div style={{ display: "flex", justifyContent: "center" }} className="voz-hero-img">
            <div style={{ position: "relative", width: "100%" }}>
              ...
              <img
                ...
                alt="Возможности платформы Промт Диалог — ИИ-инструменты для салонов красоты, психологов и частной практики"
                decoding="async"
      ...
      <section style={{ background: "#fff", padding: "120px 32px" }}>
        <div style={{ maxWidth: 1000, margin: "0 auto", background: `linear-gradient(135deg, ${DARK}, #112B3C)`, borderRadius: 6, padding: "80px 56px", textAlign: "left", position: "relative", overflow: "hidden" }}>
          ...
          <p style={{ fontSize: 18, color: "rgba(255,255,255,0.6)", margin: "0 0 10px", fontWeight: 300, position: "relative" }}>
            Создайте профиль и получите доступ к инструментам платформы.
          </p>
