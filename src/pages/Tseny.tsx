...
const PACKAGES = [
  {
    ...
    features: ["150 энергий", "Все инструменты", "3 лендинга в конструкторе", "Техническая поддержка"],
    popular: false,
  },
  {
    code: "business",
    ...
    features: ["550 энергий", "Все инструменты", "5 лендингов в конструкторе", "Приоритетная поддержка", "Экономия 15%"],
    popular: true,
  },
  {
    code: "growth",
    ...
    features: ["1200 энергий", "Все инструменты", "10 лендингов в конструкторе", "Приоритетная поддержка", "Экономия 33%"],
    popular: false,
  },
  {
    code: "premium",
    ...
    features: ["3000 энергий", "Все инструменты", "50 лендингов в конструкторе", "VIP-поддержка", "Экономия 50%", "Личный менеджер"],
    popular: false,
  },
];
