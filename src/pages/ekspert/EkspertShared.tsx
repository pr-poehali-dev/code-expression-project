...
export const AFTER_MEETINGS = [
  ...
  "Перестает эмоционально зависеть от клиентов",
];
...
export const TOOLS = [
  ...
  },
  {
    ...
    text: "Создает персональные схемы работы, техники, последовательности и протоколы сопровождения. Специалист быстрее работает и меньше теряется.",
...
export const RESULTS = [
  { icon: "Brain",      title: "Мышление",  items: ["Внутренняя устойчивость", "Уверенность", "Спокойствие"] },
  { icon: "Settings2",  title: "Практика",  items: ["Системная работа", "Высокий уровень сопровождения", "Профессиональная глубина"] },
  { icon: "Gem",        title: "Финансы",   items: ["Повышение чека", "Стабильность", "Платежеспособная аудитория"] },
  { icon: "Star",       title: "Репутация", items: ["Доверие", "Рекомендации", "Сильное позиционирование"] },
  { icon: "Wind",       title: "Состояние", items: ["Меньше тревоги", "Больше контроля", "Внутренняя свобода"] },
];