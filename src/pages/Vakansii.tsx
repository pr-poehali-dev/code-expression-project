...
const vacancies = [
  ...
  {
    id: "massaj",
    tag: "Оценка специалиста",
    title: "Массажист / Body-мастер",
    subtitle: "в премиальный сегмент — партнёрские салоны",
    description:
      "Профессиональный отбор специалистов уровня Dok Диалог. Пройдите AI-интервью и узнайте свою готовность к работе с платёжеспособными клиентами. По итогам — рекомендации по развитию и возможность попасть в кадровый резерв проекта.",
    conditions: ["Анализ уровня готовности", "Рекомендации по развитию", "Кадровый резерв проекта"],
    badge: "Идёт отбор",
    badgeColor: "#7a5c28",
    badgeBg: "#fdf6ea",
    href: "/massaj",
