...
const EXERCISES = [
  {
    ...
    subtitle: "Снизить внутреннее напряжение",
    desc: "Помогает быстро снизить уровень тревоги — прямое воздействие на нервную систему через дыхание. Тело «выключает» стресс-реакцию: мышцы расслабляются, сердце замедляется, голова проясняется.",
    color: "hsl(185, 85%, 32%)",
    bg: "hsl(185, 85%, 97%)",
  },
  {
    ...
    subtitle: "Когда тревога резко усиливается",
    desc: "Способ остановить нарастающую тревогу в моменте — когда внутри резко «накрывает». Возвращает ощущение почвы под ногами и помогает выйти из острого состояния за 2–3 минуты.",
    color: "hsl(270, 60%, 45%)",
    bg: "hsl(270, 60%, 97%)",
  },
  {
    ...
    subtitle: "Выход из тревожных мыслей",
    desc: "Возвращает контроль над вниманием — когда мысли зацикливаются и невозможно «выйти из головы». Не медитация, а конкретный приём, который переключает нервную систему в режим покоя.",
    color: "hsl(12, 80%, 45%)",
    bg: "hsl(12, 80%, 97%)",
  },
];
