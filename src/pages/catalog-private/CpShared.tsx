...
export const ONLINE_COURSES: Course[] = [
  {
    ...
    buyUrl: "https://school.brossok.ru/buy/15",
  },
  {
    id: 2,
...
export const OFFLINE_COURSES: Course[] = [
  {
    id: 101,
    title: "Для массажистов: восстановительные техники и работа с болью",
    description: "Научитесь видеть тело иначе — находить источник боли и зажимов, работать с шеей, плечами и поясницей. Для практикующих мастеров, которые хотят давать клиентам более глубокий результат.",
    bullets: [
      "Диагностика руками и поиск источника напряжения",
      "Восстановительные техники для шеи, спины и поясницы",
      "Стать специалистом, а не просто массажистом",
    ],
    price: "от 5 000 ₽",
    level: "practitioner",
    direction: "income",
    ...
    detailUrl: "/course/offline-intensiv-dlya-massazhistov",
    bookUrl: "/course/offline-intensiv-dlya-massazhistov",
    buyUrl: "/course/offline-intensiv-dlya-massazhistov",
  },
  {
    id: 102,
    title: "Для тренеров: восстановление как часть результата",
    description: "Освойте восстановительные техники и начните видеть тело не только через нагрузку, но и через восстановление. Давайте клиентам результат, которого не могут дать другие тренеры.",
    bullets: [
      "Определять зоны напряжения и ограничения движения",
      "Мягкие техники для шеи, спины и плеч",
      "Выделяться среди других специалистов",
    ],
    price: "от 5 000 ₽",
    level: "practitioner",
    direction: "income",
    format: "offline",
    duration: "1 день",
    image: "https://cdn.poehali.dev/projects/10f61e56-9821-40f3-b705-3590ddaffd08/files/c3f8bda4-d2bf-4e8f-bb93-e8b5ed534242.jpg",
    detailUrl: "/course/offline-intensiv-dlya-trenerov",
    bookUrl: "/course/offline-intensiv-dlya-trenerov",
    buyUrl: "/course/offline-intensiv-dlya-trenerov",
  },
  {
    id: 103,
    title: "Для семьи: помочь близким, когда болит спина или шея",
    description: "Простые восстановительные техники без медобразования — для тех, кто хочет помогать себе и близким. Снять напряжение после тяжёлого дня, облегчить боль в спине, почувствовать себя лучше.",
    bullets: [
      "Простые техники без медицинского образования",
      "Работа с шеей, плечами, спиной и поясницей",
    ...
    format: "offline",
    duration: "1 день",
    image: "https://cdn.poehali.dev/projects/10f61e56-9821-40f3-b705-3590ddaffd08/files/8553a2c8-98a9-4d7d-a71d-03832b1f87d5.jpg",
    detailUrl: "/course/offline-intensiv-dlya-semi",
    bookUrl: "/course/offline-intensiv-dlya-semi",
    buyUrl: "/course/offline-intensiv-dlya-semi",
  },
  {
    id: 104,
    title: "Начало карьеры: войти в профессию с нуля",
    description: "Хотите освоить востребованную профессию и помогать людям? Получите базу профессионального мышления и рабочие техники — без медобразования и многолетнего обучения.",
    bullets: [
      "Понимание логики работы с телом с первого дня",
      "Практические техники для старта в профессии",
      "Навык, который можно сразу монетизировать",
    ],
    price: "от 5 000 ₽",
    level: "beginner",
    direction: "income",
    format: "offline",
    duration: "1 день",
    image: "https://cdn.poehali.dev/projects/10f61e56-9821-40f3-b705-3590ddaffd08/files/8b063f72-36e2-4539-9437-4ba5223e0130.jpg",
    detailUrl: "/course/offline-intensiv-karera",
    bookUrl: "/course/offline-intensiv-karera",
    buyUrl: "/course/offline-intensiv-karera",
  },
];