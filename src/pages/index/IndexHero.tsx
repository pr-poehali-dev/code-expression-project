...
const AUDIENCE = [
  ...
  },
  {
    ...
    border: "#bbf7d0",
    tag: "Компаниям",
    title: "Для салонов, центров и команд",
    desc: "Салоны красоты, SPA, психологические и wellness-центры, клиники эстетики и другие команды специалистов.",
    fit: ["Обращения есть, а выручки нет", "Слабые места в загрузке команды", "Реклама без чёткого расчёта"],
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "100px 32px", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }} className="hero-grid">
          <div>
            ...
            <div style={{ display: "flex", gap: 36, marginTop: 48, flexWrap: "wrap" }}>
              {[["200+", "команд и специалистов"], ["20+", "инструментов"], ["4.9", "средняя оценка"]].map(([v, l], i) => (
                <div key={i}>
