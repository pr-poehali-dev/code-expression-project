...
export const BUY_URL_DISCOUNT = "https://school.brossok.ru/buy/74";
...
export const MODULES = [
  {
    title: "Модуль 1. Фундамент. Диагностика и базовое выстраивание тела",
    lessons: [
      "Быстрая диагностика осанки и мышечного баланса",
      "Протокол «Заземление»: восстанавливаем опору и стабильность тела",
      "Техника снятия напряжения с диафрагмы и улучшения дыхания",
      "Висцеральный лифтинг: мягкий подъём органов для улучшения осанки",
      "Восстановление дыхательного объёма: техника для раскрытия лёгких",
    ],
  },
  {
    title: "Модуль 2. Боль и дискомфорт в спине",
    lessons: [
      "Выравнивание грудной клетки при сутулости и болях между лопатками",
      "Пальпация позвоночника: находим истинные источники боли",
      "Протокол при острой и хронической боли в пояснице",
      "Коррекция крестца: ключ к стабильности таза и поясницы",
      "Мягкая коррекция позвонков: убираем функциональные блоки",
      "Работа с лопатками: снимаем боль и восстанавливаем подвижность плеч",
      "Протокол при сколиозе и асимметрии грудного отдела",
      "Мобилизация рёбер: улучшаем дыхание и убираем боль в груди",
    ],
  },
  {
    title: "Модуль 3. Шея, голова и работа с последствиями стресса",
    lessons: [
      "Экстренная помощь при головной боли напряжения",
      "Работа с ВНЧС: снимаем челюстные зажимы и скрежет зубов",
      "Техника для снятия ментального напряжения и «тяжести» в голове",
      "Снятие зажимов в затылке и восстановление краниального ритма",
      "Безопасная работа с шейными позвонками при ограничении подвижности",
      "Коррекция Атланта: протокол при головокружениях и мигренях",
    ],
  },
  {
    title: "Модуль 4. Конечности и лимфатическая система",
    lessons: [
      "Техника для снятия усталости и тяжести в ногах",
      "Протокол «Разблокировка» плечевого пояса и ключиц",
      "Лимфодренажный запуск за 5 минут: убираем отёки и тяжесть",
    ],
  },
  {
    title: "Модуль 5. Глубинные техники. Нервная система и висцеральная практика",
    lessons: [
      "Нейрокоррекция: техника балансировки вегетативной нервной системы",
      "Протокол «Парасимпатический запуск» для глубокого расслабления",
      "Висцеральный массаж: улучшаем моторику кишечника",
      "Общий протокол «Запуск ОДА»: комплексная настройка опорно-двигательного аппарата",
    ],
  },
  {
    title: "Модуль 6. Работа с вегетативной нервной системой (ВНС)",
    lessons: [
      "Почему массажисту критически важно понимать ВНС",
      "Что такое ВНС и чем она не является",
      "Два лика ВНС: симпатика и парасимпатика",
      "ВНС и мышечный тонус: где живёт гипертонус",
      "ВНС и кровообращение / лимфоток: тепло, холод, отёки",
      "ВНС и воспаление / боль: нейрогенное воспаление",
      "ВНС и фасции: напряжение за гранью мышц",
      "Главный разрушитель баланса ВНС — стресс",
      "Как ваши руки говорят с автономным дирижёром",
      "Остеопатический взгляд: работа с клиентом",
      "Практика с вегетативными ганглиями. 1 этап",
      "Практика. 2 этап",
    ],
  },
];
