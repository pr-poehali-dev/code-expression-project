...
export default function RepPage() {
  ...
  useEffect(() => {
    document.title = "Кабинет представителя — Промт Диалог";
  }, []);
    ...
    return (
      <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "#f8f8f6", fontFamily: "Montserrat, sans-serif", padding: 24 }}>
        <div style={{ textAlign: "center", maxWidth: 360 }}>
          ...
          <div style={{ fontSize: 14, color: "#888" }}>Этот раздел доступен только представителям Промт Диалог. Обратитесь к администратору.</div>
        </div>
      </div>
    );
  }
