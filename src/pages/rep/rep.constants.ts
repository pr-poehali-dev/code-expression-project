...
export const EMAIL_TEMPLATES = [
  {
    ...
    body: `<p>Хотите повысить прибыль салона и упростить работу команды? Приглашаем вас зарегистрироваться на платформе <strong>«Про Диалог»</strong> и получить <strong>бонусный баланс для бесплатного тестирования всех ИИ-инструментов</strong>!</p>
