...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { num: "7.1.", text: "Стоимость услуг определяется тарифными планами, опубликованными на Платформе по адресу https://promtdialog.ru/tseny." },
  ...
  },
  {
    ...
    items: [
      { num: "8.1.", text: "Исполнитель не несёт ответственности за действия Пользователей, а также за ущерб вследствие применения материалов Платформы." },
