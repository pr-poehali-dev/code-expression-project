...
const SECTIONS = [
  {
    ...
    items: [
      { num: "1.1.", text: "Платформа (Сайт) — интернет-платформа «МассоПРО» по адресу https://docdialog.ru." },
  ...
  },
  {
    ...
    items: [
      { num: "3.1.", text: "Платформа «МассоПРО» является информационным посредником и не осуществляет медицинскую или образовательную деятельность." },
          ...
          <FadeIn>
            <div style={{ background: "#fff", borderRadius: 20, padding: "32px 36px", boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
              ...
              {[
                ...
                "В соответствии со статьёй 437 ГК РФ данный документ является публичной офертой. Лицо, осуществившее акцепт, становится Пользователем платформы «МассоПРО».",
              ].map((p, i) => (
