    ...
    <div style={{ background: BG, color: "#1a1a1a", fontFamily: "Montserrat, sans-serif", minHeight: "100vh" }}>
      ...
      <section style={{ paddingTop: 120, paddingBottom: 72, background: "#fff" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
          ...
          <FadeIn delay={100}>
            <h1 style={{ fontFamily: "Cormorant, serif", fontSize: "clamp(38px, 5.5vw, 68px)", fontWeight: 700, lineHeight: 1.08, color: "#1a1a1a", marginBottom: 28, maxWidth: 820, letterSpacing: "-0.5px" }}>
              Массаж в вашем салоне —<br />
              <span style={{ color: ACCENT }}>источник дохода,<br />а не головная боль</span>
            </h1>
          </FadeIn>
          <FadeIn delay={200}>
            <p style={{ fontSize: "clamp(15px, 2.2vw, 18px)", lineHeight: 1.8, color: "#4a4a4a", maxWidth: 640, marginBottom: 40 }}>
