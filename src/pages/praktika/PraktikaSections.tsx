...
export default function PraktikaSections() {
  return (
    <>
      {/* ── БОЛЬ ── */}
      <section className="pr-section-pad" style={{ background: DARK2 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: 2 }}>
            {PAINS.map((pain, i) => (
              <FadeIn key={i} delay={i * 40}>
                <div style={{ padding: "24px 20px", background: DARK3, borderLeft: `2px solid ${GOLD}30` }}>
                  <div style={{ width: 20, height: 1, background: `${GOLD}50`, marginBottom: 14 }} />
      ...
      {/* ── ПЕРЕЛОМ ── */}
      <section className="pr-section-pad" style={{ borderBottom: `1px solid rgba(255,255,255,0.06)` }}>
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px" }}>
          <FadeIn>
            ...
            <h2 style={{
              ...
              fontWeight: 700, color: "#fff", lineHeight: 1.15, marginBottom: 36,
            }}>
              Проблема не в техниках.{" "}
          ...
          <div className="pr-price-grid">
            <FadeIn delay={100}>
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.16em", color: TEXT_SUB, textTransform: "uppercase" as const, marginBottom: 18 }}>Сейчас</div>
            ...
            <FadeIn delay={180}>
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.16em", color: GOLD, textTransform: "uppercase" as const, marginBottom: 18 }}>После</div>
                <div style={{ display: "flex", flexDirection: "column" as const, gap: 12 }}>
            ...
            <FadeIn>
              <div>
                ...
                <h2 style={{
                  ...
                  Люди платят не за хаотичные упражнения.{" "}
              ...
              <div style={{ display: "flex", flexDirection: "column" as const, gap: 10 }}>
                {["Понимает, что делать", "Перестаёт теряться в сессии", "Работает системно", "Чувствует уверенность в практике", "Вызывает доверие клиентов"].map((t, i) => (
                  <div key={i} style={{
                    ...
                    padding: "13px 16px", background: DARK2,
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px", textAlign: "center" as const }}>
          <FadeIn>
            ...
            <h2 style={{
              ...
              Премиальный клиент чувствует специалиста{" "}
              <span style={{ color: GOLD }}>за первые минуты.</span>
            </h2>
            <p style={{ fontSize: 15, color: TEXT_SUB, lineHeight: 1.85, maxWidth: 560, margin: "0 auto 40px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 2 }}>
            {["Перестаёт заискивать", "Держит профессиональную позицию", "Спокойно говорит о стоимости", "Воспринимает себя иначе"].map((t, i) => (
              <FadeIn key={i} delay={i * 60}>
                <div style={{ padding: "22px 16px", background: DARK3, borderTop: `2px solid ${GOLD}30` }}>
      ...
      {/* ── ПРОГРАММА ── */}
      <section id="program" className="pr-section-pad" style={{ borderBottom: `1px solid rgba(255,255,255,0.06)` }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
          <FadeIn>
          ...
          <div className="pr-modules">
            {MODULES.map((m, i) => (
              <FadeIn key={i} delay={i * 40}>
                <div style={{
                  padding: "24px 22px", background: DARK2,
                  borderLeft: `1px solid rgba(255,255,255,0.05)`,
                  borderBottom: `1px solid rgba(255,255,255,0.05)`,
                }}>
                  <div style={{ fontFamily: "Cormorant, serif", fontSize: 26, fontWeight: 700, color: `${GOLD}40`, marginBottom: 10 }}>{m.n}</div>
                  <div style={{ fontSize: 14, fontWeight: 700, color: "#fff", marginBottom: 7 }}>{m.title}</div>
            ...
            <FadeIn>
              <div>
                ...
                <h2 style={{
                  fontFamily: "Cormorant, serif",
                  fontSize: "clamp(24px, 3.5vw, 42px)",
                  fontWeight: 700, color: "#fff", margin: "0 0 8px", lineHeight: 1.2,
                }}>
      ...
      {/* ── ФИНАЛ ЭМОЦИЯ ── */}
      <section className="pr-section-pad" style={{ textAlign: "center" as const }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 24px" }}>
          <FadeIn>
            ...
            <h2 style={{
              ...
              Вы можете быть сильным специалистом{" "}
              <span style={{ color: GOLD }}>и при этом жить спокойно, уверенно и достойно.</span>
            </h2>
            <p style={{ fontSize: "clamp(14px, 1.8vw, 16px)", color: TEXT_SUB, lineHeight: 1.85, marginBottom: 40 }}>
          ...
          <FadeIn delay={100}>
            <div style={{
              ...
              {[["Из хаоса", "В систему"], ["Из тревоги", "В уверенность"], ["Из выживания", "В практику"]].map(([from, to], i) => (
                <div key={i} style={{ padding: "18px 14px", background: DARK2, textAlign: "center" as const }}>
