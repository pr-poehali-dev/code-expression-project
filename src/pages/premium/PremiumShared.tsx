...
export const RESULTS = [
  { icon: "🎯", title: "Уверенность", items: ["Спокойствие", "Внутренняя опора", "Устойчивость"] },
  { icon: "⚙️", title: "Практика", items: ["Системная работа", "Структура", "Профессиональное мышление"] },
  { icon: "💎", title: "Доход", items: ["Повышение чека", "Платёжеспособные клиенты", "Стабильность"] },
  { icon: "⭐", title: "Репутация", items: ["Доверие", "Рекомендации", "Ощущение профессионализма"] },
  { icon: "🌊", title: "Состояние", items: ["Меньше тревоги", "Меньше хаоса", "Контроль над практикой"] },
];
