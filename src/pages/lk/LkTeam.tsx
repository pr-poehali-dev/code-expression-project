...
const inp: React.CSSProperties = { width: "100%", padding: "10px 13px", borderRadius: 9, border: "1.5px solid #e8e8e4", fontSize: 13, fontFamily: "Montserrat,sans-serif", background: "#fafaf8", boxSizing: "border-box", color: "#1a1a1a", outline: "none" };

// ── Тоггл разрешения ──────────────────────────────────────────────────────────
function PermToggle({ label, value, onChange }: { label: string; value: boolean; onChange: (v: boolean) => void }) {
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 0", borderBottom: "1px solid #f5f5f2" }}>
    ...
    <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #eee", overflow: "hidden" }}>
      <div style={{ padding: "14px 18px", display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 14, fontWeight: 700, color: "#1a1a1a" }}>{member.full_name}</div>
      ...
      {open && (
        <div style={{ padding: "0 18px 18px", borderTop: "1px solid #f5f5f2" }}>
          ...
          <div style={{ marginTop: 14, marginBottom: 14 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              {ROLE_OPTIONS.map(r => (
                ...
                }} style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 10, border: `1.5px solid ${role === r.code ? ACCENT : "#eee"}`, background: role === r.code ? `hsla(185,85%,32%,0.05)` : "#fafaf8", cursor: "pointer", fontFamily: "Montserrat,sans-serif", textAlign: "left" }}>
          ...
          <div style={{ marginBottom: 14 }}>
            ...
            <div style={{ background: "#fafaf8", borderRadius: 10, padding: "4px 12px" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            {confirmRemove ? (
              ...
              <button onClick={() => setConfirmRemove(true)} style={{ padding: "10px 14px", borderRadius: 10, border: "1px solid #eee", background: "#fff", color: "#aaa", fontSize: 13, cursor: "pointer", fontFamily: "Montserrat,sans-serif", display: "flex", alignItems: "center", gap: 6 }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = "hsl(0,75%,85%)"; e.currentTarget.style.color = "hsl(0,75%,55%)"; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = "#eee"; e.currentTarget.style.color = "#aaa"; }}>
...
function InviteForm({ onInvited }: { onInvited: (invite: Invite) => void }) {
  ...
  return (
    <form onSubmit={handleSubmit} style={{ background: "#fff", borderRadius: 16, border: `1.5px solid ${ACCENT}`, padding: "20px" }}>
      <div style={{ fontSize: 13, fontWeight: 700, color: "#1a1a1a", marginBottom: 16 }}>Пригласить сотрудника</div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
          {ROLE_OPTIONS.map(r => (
            <button key={r.code} type="button" onClick={() => setRoleCode(r.code)}
              style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 12px", borderRadius: 10, border: `1.5px solid ${roleCode === r.code ? ACCENT : "#eee"}`, background: roleCode === r.code ? `hsla(185,85%,32%,0.05)` : "#fafaf8", cursor: "pointer", fontFamily: "Montserrat,sans-serif", textAlign: "left" }}>
...
function PendingInvite({ invite }: { invite: Invite }) {
  ...
  return (
    <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #eee", padding: "12px 16px", display: "flex", alignItems: "center", gap: 12 }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ fontSize: 13, fontWeight: 700, color: "#1a1a1a" }}>{invite.full_name}</div>
    ...
    <div style={{ maxWidth: 680 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, flexWrap: "wrap", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            <h2 style={{ fontSize: "clamp(18px,2.5vw,22px)", fontWeight: 700, color: "#1a1a1a", margin: 0 }}>Команда</h2>
      ...
      {loading ? (
        ...
        <div>
          ...
          <div style={{ background: "#fff", borderRadius: 14, border: "1px solid #eee", padding: "16px 18px", display: "flex", alignItems: "center", gap: 12 }}>
