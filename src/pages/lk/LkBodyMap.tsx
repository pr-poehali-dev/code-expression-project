...
const ZONES_FRONT: ZoneHotspot[] = [
  ...
  { slug: "upper-arm-right", label: "Плечо (прав.)",    x: 7,    y: 18,   w: 5,   h: 13  },
  { slug: "upper-arm-left",  label: "Плечо (лев.)",     x: 32,   y: 18,   w: 5,   h: 13  },
  { slug: "forearm-right",   label: "Предплечье (пр.)", x: 4,    y: 31,   w: 4.5, h: 11  },
  { slug: "forearm-left",    label: "Предплечье (лев.)",x: 35.5, y: 31,   w: 4.5, h: 11  },
  { slug: "thigh-right",     label: "Бедро (прав.)",    x: 18,   y: 48,   w: 6,   h: 14  },
  { slug: "thigh-left",      label: "Бедро (лев.)",     x: 24,   y: 48,   w: 6,   h: 14  },
  { slug: "knee-right",      label: "Колено (прав.)",   x: 18,   y: 62,   w: 5.5, h: 5   },
  { slug: "knee-left",       label: "Колено (лев.)",    x: 24,   y: 62,   w: 5.5, h: 5   },
  { slug: "shin-right",      label: "Голень (прав.)",   x: 17.5, y: 67,   w: 5,   h: 16  },
  { slug: "shin-left",       label: "Голень (лев.)",    x: 23.5, y: 67,   w: 5,   h: 16  },
