...
const ZONES_BACK: ZoneHotspot[] = [
  ...
  { slug: "upper-arm-right", label: "Плечо (прав.)",    x: 58,   y: 18,   w: 5,   h: 13  },
  { slug: "upper-arm-left",  label: "Плечо (лев.)",     x: 83.5, y: 18,   w: 5,   h: 13  },
  { slug: "forearm-right",   label: "Предплечье (пр.)", x: 55,   y: 31,   w: 4.5, h: 11  },
  { slug: "forearm-left",    label: "Предплечье (лев.)",x: 87,   y: 31,   w: 4.5, h: 11  },
  { slug: "thigh-right",     label: "Бедро (прав.)",    x: 68,   y: 48,   w: 6,   h: 14  },
  { slug: "thigh-left",      label: "Бедро (лев.)",     x: 74,   y: 48,   w: 6,   h: 14  },
  { slug: "knee-right",      label: "Колено (прав.)",   x: 68,   y: 62,   w: 5.5, h: 5   },
  { slug: "knee-left",       label: "Колено (лев.)",    x: 74,   y: 62,   w: 5.5, h: 5   },
  { slug: "shin-right",      label: "Голень (прав.)",   x: 67.5, y: 67,   w: 5,   h: 16  },
  { slug: "shin-left",       label: "Голень (лев.)",    x: 73.5, y: 67,   w: 5,   h: 16  },
