...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    icon: "Heart", color: "hsl(340,75%,50%)", bg: "hsl(340,75%,97%)",
    landings: [
      { title: "Старт", description: "Бесплатный вводный блок: 5 видео-модулей, разборы практики и демо ИИ-инструментов.", price: "Бесплатно", badge: "Бесплатно", href: "/free" },
      { title: "Практика", description: "Система для специалистов по телу — 9 модулей, доступ 12 месяцев.", price: "90 900 ₽", href: "/praktika" },
      { title: "Премиальная практика", description: "Высокий чек, 5 встреч, ИИ-инструменты. 24 месяца обучения.", price: "290 000 ₽", href: "/premium" },
      { title: "Про Диалог — Эксперт", description: "VIP. Пожизненный доступ, все обновления, 10 персональных встреч.", price: "500 000 ₽", badge: "VIP", href: "/ekspert" },
    ],
  },
];
