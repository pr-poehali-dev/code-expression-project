...
const QUICK_PROMPTS = [
  "Напиши пост в соцсети о тарифе «Профи» для специалистов",
  "Придумай скрипт продажи тарифа «Бизнес» для салона",
  "Напиши описание курса «Массажист с потоком клиентов»",
  "Составь коммерческое предложение для салона на тариф «Премиум»",
  "Какие возражения чаще всего у клиентов и как их закрывать?",
  "Напиши приветственное письмо для нового пользователя ЛК",
];
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 8 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "#999" }}>GPT-4.1 mini · знает весь проект</div>
          </div>
        </div>
        {messages.length > 0 && (
