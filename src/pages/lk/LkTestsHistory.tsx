import { ACCENT, MindsetHistoryItem, BarriersHistoryItem } from "./LkTestsTypes";
...
export default function LkTestsHistory({ mindsetHistory, barriersHistory, onViewMindset, onViewBarriers, onRetakeMindset, onRetakeBarriers }: Props) {
  return (
    <>
