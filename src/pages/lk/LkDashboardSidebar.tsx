...
const INSTALL_INSTRUCTIONS: Record<string, { subtitle: string; steps: string[] }> = {
  ...
  yandex: {
    ...
    steps: [
      'Нажмите три точки (⋮) — они находятся внизу справа или вверху справа, видны за этой шторкой',
  ...
  "android-chrome": {
    ...
    steps: [
      'Нажмите три точки (⋮) в правом верхнем углу — прямо сейчас они видны за этой шторкой',
