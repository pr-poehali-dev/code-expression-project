...
export const MODULES = [
  {
    title: "Введение. Почему массажисту важно понимать ВНС",
    lessons: [
      "Почему массажисту критически важно понимать ВНС",
    ],
  },
  {
    title: "ВНС — дирижёр внутреннего оркестра",
    lessons: [
      "Что такое ВНС и чем она не является",
      "Два лика ВНС: симпатика и парасимпатика",
      "Как ВНС конкретно влияет на ткани",
    ],
  },
  {
    title: "Как ВНС влияет на тело",
    lessons: [
  ...
  {
    title: "Стресс — главный разрушитель баланса ВНС",
    lessons: [
      "Стресс и его влияние на вегетативный баланс",
    ],
  },
  {
    title: "Массаж как инструмент влияния на ВНС",
    lessons: [
      "Научное обоснование: как руки говорят с автономным дирижёром",
    ],
  },
  {
    title: "Интеграция знаний о ВНС в практику",
    lessons: [
      "Остеопатический взгляд: работа с клиентом",
    ],
  },
  {
    title: "Ключ к быстрой саморегуляции (видеоуроки)",
    lessons: [
      "Работа с вегетативными ганглиями. Практика. 1 этап",
      "Практика. 2 этап",
    ],
  },
];
