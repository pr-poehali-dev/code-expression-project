...
import { ACCENT, h2style, BtnPay, BtnBook, AccordionItem } from "./CoiTrenShared";

export default function CoiTrenPricingSection() {
  return (
    <>
      {/* ── БЛОК ОПЛАТЫ ── */}
      ...
      <section style={{ padding: "80px 0" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
          ...
          <AccordionItem title="Для кого подходит интенсив?">
            Для тренеров, фитнес-инструкторов и других специалистов в области движения, которые хотят расширить навыки за пределы тренировочного процесса и давать клиентам более глубокий результат.
          </AccordionItem>
          <AccordionItem title="Нужно ли медицинское образование?">
            Нет. Все техники адаптированы для тренеров без медицинского фона. Обучение строится на практике и понятных объяснениях — без сложной терминологии.
          </AccordionItem>
