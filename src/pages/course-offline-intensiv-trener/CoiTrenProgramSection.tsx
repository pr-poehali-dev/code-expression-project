...
import { ACCENT, BG, h2style } from "./CoiTrenShared";
...
const SCHEDULE = [
  {
    ...
    desc: "Участники знакомятся, обозначают свои запросы. Разминка — настройка тела и внимания перед практикой.",
    tag: null,
  },
  {
    time: "10:30–12:30",
    label: "Блок 1",
    title: "Тело и движение: где прячется напряжение",
    desc: "Разбираем, как хронические зажимы и ограничения влияют на движение и качество тренировок. Учимся видеть телесные паттерны и понимать, почему прогресс замедляется, когда тело перегружено.",
    tag: "Диагностика",
    topics: [
      "Как тело реагирует на стресс и перегрузку",
      "Зоны хронического напряжения и их влияние на движение",
      "Тактильная диагностика: учимся читать тело руками",
      "Связь напряжения в шее, плечах и пояснице",
    ],
    practice: true,
  },
  {
  ...
  },
  {
    time: "14:00–16:30",
    label: "Блок 2",
    title: "Восстановительные техники: инструменты для тренера",
    desc: "Мягкие и эффективные техники восстановления, которые тренер может применять в работе. Улучшение подвижности, снятие напряжения, возврат лёгкости движения.",
    tag: "Восстановление",
    topics: [
      "Техники для шеи и плечевого пояса — мягко и безопасно",
      "Работа с поясницей и спиной: снятие хронического напряжения",
      "Антистресс-техники: переключаем нервную систему в режим восстановления",
      "Как улучшить подвижность суставов перед и после тренировки",
      "Практика в парах: работаем на реальных запросах",
    ],
    practice: true,
  },
  {
  ...
  },
  {
    time: "17:00–18:00",
    label: "Финал дня",
    title: "Интеграция — как использовать техники в тренерской практике",
    desc: "Разбираем, как внедрять восстановительные техники в работу с клиентами. Каждый участник проводит мини-сеанс и получает обратную связь от тренера.",
    tag: null,
    topics: [
      "Когда и как применять техники — до, во время или после тренировки",
      "Разбор ошибок и практические рекомендации от тренера",
...
export default function CoiTrenProgramSection() {
  return (
    <>
      {/* ── ПРОГРАММА ── */}
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ background: "#fff", border: "1px solid #e8e8e4", borderRadius: 20, padding: "32px 36px" }}>
            <p style={{ fontSize: 16, color: "#555", lineHeight: 1.75, margin: "0 0 24px" }}>
              Для тренеров и инструкторов, которые хотят давать клиентам более глубокий результат — не только через нагрузку, но и через восстановление.
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }} className="problems-grid">
              {[
                ...
                "Расширить навыки за пределы тренировки",
                "Лучше понимать тело и движение",
                "Научиться восстановительным техникам без сложной медицины",
                "Помогать клиентам двигаться без боли и ограничений",
              ].map((t) => (
          ...
          <div className="coi-bonus-online" style={{
            ...
            <div>
              ...
              <div style={{ fontSize: 14, color: "#666", lineHeight: 1.65 }}>
                Спокойно пересматривайте материал и внедряйте методики в работу шаг за шагом. Все курсы остаются с вами навсегда.
              </div>
            </div>
          </div>
        </div>
