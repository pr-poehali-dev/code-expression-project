...
export default function CourseOfflineIntensivKarera() {
  return (
    <div style={{ background: BG, minHeight: "100vh", fontFamily: "Montserrat, sans-serif", color: "#1a1a1a" }}>
      <Helmet>
        <title>Интенсив для начинающих: старт карьеры в восстановительных техниках | Dok Диалог</title>
        <meta name="description" content="Однодневный офлайн интенсив для тех, кто хочет начать карьеру в восстановительных техниках. С нуля, без медобразования. Востребованная профессия, которая помогает людям." />
        <meta name="keywords" content="начать карьеру восстановительный массаж, интенсив с нуля, новая профессия массажист, курс для начинающих восстановительные техники, как стать специалистом по восстановлению" />
        <meta property="og:title" content="Интенсив: старт карьеры в восстановительных техниках" />
        <meta property="og:description" content="За 1 день — база профессионального мышления и рабочие техники. С нуля. Группа до 12 человек." />
