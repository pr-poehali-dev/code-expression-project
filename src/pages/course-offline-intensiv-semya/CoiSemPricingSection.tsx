...
import { ACCENT, h2style, BtnPay, BtnBook, AccordionItem } from "./CoiSemShared";

export default function CoiSemPricingSection() {
  return (
    <>
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 8 }}>
                  ...
                  <span style={{ fontSize: 13.5, color: "#555" }}>
                    Интенсив проходит <strong>каждое воскресенье</strong> — выберите удобную дату
                  </span>
                </div>
              </div>
            </div>
      ...
      <section style={{ padding: "80px 0" }}>
        <div style={{ maxWidth: 720, margin: "0 auto", padding: "0 24px" }}>
          ...
          <AccordionItem title="Нужно ли медицинское образование?">
            Нет, совсем не нужно. Интенсив специально разработан для людей без медицинского фона. Все техники простые, мягкие и безопасные.
          </AccordionItem>
          <AccordionItem title="Смогу ли я применять это дома?">
            Да, именно для этого и создан интенсив. Вы уйдёте с практическими навыками, которые сможете использовать в обычной жизни — для себя и близких.
          </AccordionItem>
          ...
          <AccordionItem title="Можно ли прийти вдвоём с партнёром или другом?">
            Да, можно записаться вместе — это даже удобнее, так как часть практики проходит в парах. Запишите двоих через форму или свяжитесь с нами.
          </AccordionItem>
