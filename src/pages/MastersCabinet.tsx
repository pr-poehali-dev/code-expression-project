...
function InstructionCard() {
  const steps = [
    ...
    { icon: "UserCheck", title: "Владелец регистрируется", desc: "Он переходит по ссылке и создаёт аккаунт на «Промт Диалог». Привязка происходит автоматически — вы нигде не упоминаетесь." },
