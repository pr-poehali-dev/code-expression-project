...
const RESULTS = [
  ...
  { icon: "Bot", title: "ИИ-агенты", desc: "Персональные ИИ-ассистенты для бизнеса, маркетинга, сервиса и администрирования — работают в режиме диалога." },
  { icon: "BookOpen", title: "Академия Про Диалог", desc: "Пространство профессионального и личного роста для команды салона." },
  { icon: "Lightbulb", title: "Опыт и развитие", desc: "Делимся опытом в развитии салонного бизнеса — проверенные практики и живые кейсы." },
];
  ...
  return (
    <div style={{ fontFamily: "Inter, sans-serif", background: "#fff" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1140, margin: "0 auto", padding: "100px 32px", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }} className="hero-grid">
          <div>
