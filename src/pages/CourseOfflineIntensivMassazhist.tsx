...
export default function CourseOfflineIntensivMassazhist() {
  return (
    <div style={{ background: BG, minHeight: "100vh", fontFamily: "Montserrat, sans-serif", color: "#1a1a1a" }}>
      <Helmet>
        <title>Интенсив для массажистов в Москве: восстановительные техники и диагностика тела | Dok Диалог</title>
        <meta name="description" content="Офлайн интенсив для практикующих массажистов в Москве. 1 день практики: диагностика руками, восстановительные техники для шеи, спины и поясницы, работа с болью и зажимами. Группа до 12 человек. От 5 000 ₽." />
        <meta name="keywords" content="интенсив для массажистов Москва, восстановительные техники массаж курс, офлайн обучение массажист, диагностика тела руками, работа с болью и зажимами, повышение квалификации массажист Москва, курс восстановительный массаж" />
        <meta property="og:title" content="Интенсив для массажистов в Москве: восстановительные техники и диагностика" />
        <meta property="og:description" content="1 день практики в Москве — диагностика руками, техники для шеи, спины и поясницы, работа с болью. Стать специалистом по восстановлению. От 5 000 ₽, группа до 12 человек." />
