      ...
      <section style={{ background: "#F8FAFC", padding: "120px 32px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center" }}>
          ...
          <p style={{ fontSize: 18, color: GRAY, lineHeight: 1.8, margin: "0 0 20px", fontWeight: 300 }}>
            «Диалог» в переводе с греческого — разговор двоих. Это не монолог салона, который рассказывает о себе, а живой обмен: вы слышите клиента, а клиент слышит вас. Настоящий диалог — это вопрос и ответ, внимание и отклик, доверие, которое рождается в каждом контакте.
          </p>
          <p style={{ fontSize: 18, color: GRAY, lineHeight: 1.8, margin: "0 0 20px", fontWeight: 300 }}>
            Салон ведёт диалог постоянно — даже когда молчит. Каждое сообщение в чате, тон администратора, ответ на отзыв, пост в социальных сетях — всё это реплики в разговоре с клиентом. И от того, насколько внимательно он ведётся, зависит, вернётся человек снова или уйдёт молча.
          </p>
          <p style={{ fontSize: 18, color: GRAY, lineHeight: 1.8, margin: "0 0 20px", fontWeight: 300 }}>
            Клиент уходит не потому, что мастер плохо работает. Он уходит, потому что диалог прервался: никто не позвал его вернуться, не услышал сомнения, не предложил заботу. Исследования показывают: 68% клиентов уходят не из-за качества услуг, а из-за ощущения, что их не слышат.
          </p>
          <p style={{ fontSize: 18, color: DARK, lineHeight: 1.8, margin: 0, fontWeight: 400 }}>
            Про Диалог помогает вести этот разговор осознанно и непрерывно — с клиентом, внутри команды и в маркетинге. Потому что там, где есть настоящий диалог, есть доверие. А там, где доверие, — есть прибыль.
          </p>
        </div>
      </section>
