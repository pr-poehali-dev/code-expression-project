    ...
    <div style={{ background: BG, minHeight: "100vh", fontFamily: "Montserrat, sans-serif", color: "#1a1a1a" }}>
      ...
      <section style={{ padding: "80px 0 0" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
          ...
          {[
            { time: "09:00–10:30", title: "Диагностика практики", desc: "Анализируем текущую ситуацию каждого участника: клиенты, доход, чек, повторные записи. Находим главные точки потерь." },
            { time: "10:45–12:30", title: "Техники повышения чека", desc: "Практические методы увеличения стоимости услуг без потери клиентов. Разбираем страхи и работаем с позиционированием." },
            { time: "13:30–15:00", title: "Система привлечения клиентов", desc: "Конкретные каналы и инструменты под каждый формат работы. Разбираем кейсы участников." },
            { time: "15:15–16:30", title: "Удержание и возврат", desc: "Как превратить разового клиента в постоянного. Скрипты, поводы для контакта, программы лояльности." },
            { time: "16:30–18:00", title: "Составление личного плана", desc: "Каждый участник уходит с индивидуальным планом действий на ближайший месяц." },
        ...
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }} className="format-grid">
            {[
              ...
              { icon: "Clock", label: "1 день", sub: "9:00–18:00" },
      ...
      <section style={{ padding: "80px 0 0" }}>
        <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ background: "#fff", border: "1px solid #e8e8e4", borderRadius: 20, padding: "36px 40px", display: "flex", gap: 32, alignItems: "flex-start" }} className="author-block">
            <div style={{ flexShrink: 0, width: 100, height: 100, borderRadius: "50%", background: `${ACCENT}15`, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <Icon name="User" size={44} style={{ color: ACCENT }} />
            </div>
            <div>
              <div style={{ fontSize: 20, fontWeight: 700, color: "#1a1a1a", marginBottom: 6 }}>Эксперт по практике массажиста</div>
              <div style={{ fontSize: 14, color: ACCENT, fontWeight: 600, marginBottom: 16 }}>Dok Диалог</div>
              <p style={{ fontSize: 14, color: "#555", lineHeight: 1.7, margin: 0 }}>
                Более 10 лет в массаже. Автор системы роста дохода для практикующих мастеров. Провёл сотни консультаций и обучил более 500 специалистов по всей России. Специализация — практическая сторона бизнеса массажиста.
              </p>
            </div>
          </div>
        </div>
