  ...
  return (
    <>
      ...
      <section style={{
        ...
        <style>{`@media(max-width:640px){.hero-bg-img{background-size:contain!important;background-position:center top!important;background-repeat:no-repeat!important;}}`}</style>
