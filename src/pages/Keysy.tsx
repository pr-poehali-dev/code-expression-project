  ...
  return (
    <div style={{ fontFamily: "Inter, sans-serif", background: "#fff" }}>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1280, margin: "0 auto", padding: "100px 32px", width: "100%", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center", position: "relative" }} className="keysy-hero-grid">
          <div>
            ...
            <p style={{ fontSize: "clamp(15px,1.6vw,18px)", color: "rgba(255,255,255,0.62)", lineHeight: 1.7, margin: "0 0 16px", fontWeight: 300, maxWidth: 520 }}>
              Реальные истории роста: как салоны увеличили выручку, вернули клиентов и загрузили мастеров.
            </p>
            <p style={{ fontSize: "clamp(13px,1.3vw,15px)", color: TEAL, lineHeight: 1.6, margin: 0, fontWeight: 500, letterSpacing: "0.5px" }}>
              Рост чека · Возврат клиентов · Загрузка мастеров
            </p>
          </div>

          <div style={{ display: "flex", justifyContent: "center" }} className="keysy-hero-img">
            <div style={{ position: "relative", width: "100%" }}>
              ...
              <img
                src="https://cdn.poehali.dev/projects/10f61e56-9821-40f3-b705-3590ddaffd08/bucket/faedd281-82dc-4d06-820f-3062765dba23.png"
                alt="Кейсы роста салонов красоты с платформой Промт Диалог"
                decoding="async"
      ...
      <style>{`
        @media (max-width: 768px) {
          .keysy-hero-grid { grid-template-columns: 1fr !important; }
          .keysy-hero-img { margin-top: 32px; }
        }
