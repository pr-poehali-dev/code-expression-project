...
import CourseOfflineIntensivKarera from "./pages/CourseOfflineIntensivKarera";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/course/offline-intensiv-karera" element={<CourseOfflineIntensivKarera />} />
