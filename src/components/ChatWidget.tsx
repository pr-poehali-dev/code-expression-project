...
const WELCOME: Message = {
  role: "assistant",
  content: "Привет! Я AI-консультант платформы «Промт Диалог». Помогу разобраться с обучением, тарифами и инструментами для салонного бизнеса. Что вас интересует?",
};
